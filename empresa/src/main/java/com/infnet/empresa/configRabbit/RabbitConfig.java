...
public class RabbitConfig {
    ...
    public static final String QUEUE_NAME = "empresaQueue";
    public static final String EXCHANGE_NAME = "empresaExchange";
    public static final String ROUTING_KEY = "empresa.#";
